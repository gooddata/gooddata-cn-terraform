...
# IAM policy for AWS Load Balancer Controller (downloaded from upstream)
resource "aws_iam_policy" "lb_controller" {
  name   = "${var.deployment_name}-AWSLoadBalancerControllerIAMPolicy"
  policy = <<POLICY
{
    "Version": "2012-10-17",
    "Statement": [
...
resource "aws_iam_role" "lb_controller" {
  name               = "${var.deployment_name}-eks-lb-controller-role"
